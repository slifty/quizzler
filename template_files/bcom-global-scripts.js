...
function showLoginRRD(twidth){if(!twidth)twidth=191;if(getCookie("pathAuth")||getCookie("pathAuthSess")){ if(((getCookie("PSyncHint"))&&(getCookie("PSyncHint")!="-"))&&(getCookie("AT"))){if(OAS_sitepage == 'www.boston.com/homepage/defaulted'){document.writeln('<div align="center"> <span id="mp"><a onclick="goToUgcProfileUrl()" href="javascript:void(0)">Profile</a></span> | <span id="mc"><a href="http://www.boston.com/?__goto=mcenter">Settings</a></span> | <span id="lo"><a href="/logout">Log out</a></span></div>')}
else{document.writeln('<div align="center"><span id="mp"><b><a onclick="goToUgcProfileUrl()" href="javascript:void(0)">' + getCookie("PSyncHint") + '\'s profile</a></b></span> | <span id="mc"><a href="http://www.boston.com/?__goto=mcenter">Member Center</a></span> | <span id="lo"><a href="/logout">Log out</a></span></div>')}}else{document.writeln('<div align="center"><span id="mc"><a href="http://www.boston.com/?__goto=mcenter&amp;Header_Regi_Preferences">Member Center</a></span> | <span id="lo"><a href="/logout?p1=Header_Regi_LogOut">Log out</a></span></div>');}}
else{document.writeln('<div align="center"><span id="si"><a href="/login?p1=Header_Regi_Signin">Sign In</a></span> | <span id="rn"><a href="http://www.boston.com/?__goto=loginpage&amp;Header_Regi_RegisterNow">Register now</a></span></div>');}}
...
$(function(){
        $(".tcCentered object").html('<param name="wmode" value="transparent" />');
});

function constantContact (){setTimeout(function(){checkNowPlaying()}, 180000);}
...
function checkNowPlaying () {
	if (($("#now-playing-header").length  > 0) || (radioType != 'none')) {

    var randomMeAway = Math.floor(Math.random()*101);
    var jsonURL = 'http://www.boston.com/ae/radio/nowplaying.json?check=' + randomMeAway;
    $.getJSON(jsonURL,
              function(data) {  if  ($("#now-playing-header .np-song-artist").text() != data.nowplaying.artist)
				{
				    $("#now-playing-header .np-song-artist").replaceWith('<span class="np-song-artist">' + data.nowplaying.artist + '</span>');
				    $("#now-playing-header .np-song-title").replaceWith('<span class="np-song-title">' + data.nowplaying.track + '</span>');
				    scrollerDome();
				}
                                else
                                {
