...
//if(!s.prop22)
//  s.prop22=s.eVar11=s.getQueryParam('s.sm.query')
if(!s.eVar1)
...
// capture screen orientation
// s.prop45=screenOrientation();
...
if (s.prop37){
    s.prop36=s.getPercentPageViewed();
		...
		//code to capture current page url
	s.prop43="D=g"  
...
var throughFB = getCookie('fbLogin'), loggedInOmniture = getCookie('pathAuth'), isBCom_PAS = getCookie('pathAuthSess');
if(loggedInOmniture!=null) {
      s.prop35 = 'logged in', s.eVar20 = 'logged in';
      if (throughFB!=null) {
            s.prop42='facebook', s.eVar42='facebook';
      } else {
            s.prop42='Boston.com', s.eVar42='Boston.com';
      }
            
} else {
      s.prop35='logged out', s.eVar20='logged out', s.prop42='n/a', s.eVar42='n/a'; 
}
...
s.getPPVSetup();
/*
 * Function for determining screen orientation of mobile devices
 */
